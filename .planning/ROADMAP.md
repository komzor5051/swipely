...
### Phase 5: Credits-based free tier — единый счётчик кредитов поверх chat-продукта, lead-magnet landing /analyze, починка analyze_profile drift, wow-onboarding после первого анализа, PostHog трекинг апселл-воронки
