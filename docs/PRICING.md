...
### Поштучная покупка (докупить недостающие)

| Тариф | Цена/слайд | Себестоимость | Маржа |
|-------|------------|---------------|-------|
| FREE | 49₽ | 13.5₽ | 72% |
| PRO | 39₽ | 13.5₽ | 65% |

Используется когда у пользователя есть частичный баланс и нужно докупить несколько слайдов.

### Пакеты слайдов (выгоднее при больших объёмах)

| Пакет | Слайдов | Цена | Цена/слайд | Экономия | Маржа |
|-------|---------|------|------------|----------|-------|
| Small | 15 | 490₽ | 33₽ | 33% vs поштучно | 59% |
| Medium | 50 | 1 490₽ | 30₽ | 39% vs поштучно | 55% |
| Large | 150 | 3 990₽ | 27₽ | 45% vs поштучно | 49% |
